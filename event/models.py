...
class Event(models.Model):
    ...
    organizer = models.ForeignKey(User, on_delete=models.CASCADE, default=1, related_name='organized_events')
    participants = models.ManyToManyField(User, through='RSVP', related_name='events_attending')
